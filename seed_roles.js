...
async function seedUsers() {
  try {
    ...
    const users = [
      { firstName: 'Admin', lastName: 'User', email: 'admin@vendorbridge.com', passwordHash, role: 'admin' },
      { firstName: 'Officer', lastName: 'User', email: 'officer@vendorbridge.com', passwordHash, role: 'procurement_officer' },
      { firstName: 'Manager', lastName: 'User', email: 'manager@vendorbridge.com', passwordHash, role: 'manager' },
      { firstName: 'Vendor', lastName: 'User', email: 'vendor@vendorbridge.com', passwordHash, role: 'vendor' }
    ];
